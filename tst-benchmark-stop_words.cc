/*
c++ -std=c++14 -pedantic -Wall -Wextra -O3 -o tst-benchmark-stop_words -I ./frozen/include ./tst-benchmark-stop_words.cc && ./tst-benchmark-stop_words < /usr/share/dict/words
*/
#include <algorithm>
#include <chrono>
#include <iostream>
